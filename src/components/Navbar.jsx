  ...
  return (
    <div className="dashboard">
              ...
              <div className="section">
                <div className="buttons mini">
                  <div className="dropdown bottom left">
                    <a tabindex="0" className="button toggle">
              ...
              <div className="section">
                <div className="buttons">
                  <div className="dropdown bottom right">
                    <a tabindex="0" className="button toggle small borderless">
                  ...
                  <div className="dropdown bottom right">
                    <a tabindex="0" className="button toggle borderless small">
      ...
      <div className="content">
        <div className="container">
          <div className="row">
            <div className="col-16 mt-20">Blank page</div>
          </div>
        </div>
      </div>
    </div>
